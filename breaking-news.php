...
<body>
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h3 class="mt-4 pb-2" style="border-bottom: 2px solid grey;">ब्रेकिंग न्यूज़</h3>
...
">
        ...
        if (mysqli_num_rows($result_sql_total_post_record) > 0) {
            ...
            if ($page_index_by_addbar > 1) {
                echo ("<li><a href='$hostname/breaking-news.php?page_index=" . ($page_index_by_addbar - 1) . "'>Prev</a></li>");
            }
            for ($i = 1; $i <= $total_page; $i++) {
                ...
                echo ("<li class=$active_page><a href='$hostname/breaking-news.php?page_index=$i'>$i</a></li>");
            }
            if ($page_index_by_addbar < $total_page) {
                echo ("<li><a href='$hostname/breaking-news.php?page_index=" . ($page_index_by_addbar + 1) . "'>Next</a></li>");
            }
            echo ("</ul>");
        }
        ?>
