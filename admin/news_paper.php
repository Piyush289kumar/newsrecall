...
<div id="admin-content">
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <h1 class="admin-heading">All News highlight</h1>
            </div>
            <div class="col-md-2">
                <a class="add-new" href="add-news_paper.php">Add News highlight</a>
            </div>
            <div class="col-md-12">
                        ...
                        if (mysqli_num_rows($result_sql_show_post_record) > 0) {
                            ...
                            while ($row = mysqli_fetch_assoc($result_sql_show_post_record)) {
                                ...
                                <tr>
                                    ...
                                    <td class='edit'><a href='update-news.php?post_id=<?php echo ($row['news_id']) ?>'><i
                                                class='fa fa-edit'></i></a></td>
                                    <td class='delete'><a
                                            href='delete-news.php?post_id=<?php echo $row['news_id']; ?>'><i
