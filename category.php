 ...
 ?>
    ...
    <div class="container-fluid">
        ...
        <?php
                    ...
                    ?>
                    <h4>विशेष : <?php echo $post_row_num['category_name']; ?></h4>
            ...
            <div class="col-md-8">
                ...
                <div class="col-12 mb-3">
                        ...
                        <hr id="hrline" class="bg-primary border-2 border-top border-primary"
             ...
             ?>
                    <!-- Card -->
                        <div class="col-12 my-1" id="postcover">
                            <div class="row">
                                <div class="col-md-5"><a href="single.php?post_id=<?php echo ($row['post_id']) ?>"><img src="admin/upload/<?php echo $row['post_img']; ?>" alt="Error" srcset=""
                                        style="border-radius: 12px;"></a></div>
                                <div class="col-md-7">
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="single.php?post_id=<?php echo ($row['post_id']) ?>"><p class="mt-0"><?php echo ($row['title']) ?></p></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12" id="categroy_icon">
                                            <p class="picon" style="margin:0; font-size: 12px; margin-right: 10px;"><i
                                                    class="fa-solid fa-user" style="padding-right: 5px;"></i><?php echo ($row['username']) ?></p>
                                            <p class="picon" style="margin: 0; font-size: 12px;"><i
                                                    class="fa-solid fa-calendar-days" style="padding-right: 5px;"></i><?php echo ($row['post_date']) ?></p>
                                        </div>
                                        <div class="col-md-2">
                                            <a href="single.php?post_id=<?php echo ($row['post_id']) ?>"><input type="button" value="देखिए >>"
                                                class="btn btn-primary btnreadmore"></a>
                                        </div>
