...
<body style="background-color: #f9f7f1;">
    ...
    <div class="container-fluid">
        <div class="row mt-2" style="font-size: 18px; text-align: center; border-bottom: 3px solid #e1412e;border-radius:12px;">
            ...
            <?php
            include("config.php");
            $page_index_by_addbar =  $_GET['post_news_id'];
            $sql_show_post_record = "SELECT *  FROM news_paper
                        LEFT JOIN user ON news_paper.author = user.user_id
                        WHERE news_paper.news_id = {$page_index_by_addbar}" or die("Query Failed!! --> sql_show_post_record");
        ...
        <div class="row">
            <div class="col-lg-6 text-center">
                ...
                <img class="image2" src="admin/upload/<?php echo $row['pdf']; ?>" alt="unlink" style="border:1px solid trasnparent; border-radius: 12px;" />
            ...
            <div class="col-lg-6 mt-2" style="margin-bottom:0%;">
                ...
                <div class="row">
                    <div class="col-6">
                        <p class="post_des_text" style="text-align: justify;border-right:1px solid gray;padding-right: 12px;margin-right: -5%; font-weight:400;"><span style="color: red;">संवाददाता</span> : <?php echo substr($row['des'], 0, strlen($row['des']) / 2); ?>
                        </p>
                    </div>
                    <div class="col-6">
                        <p class="post_des_text" style="text-align: justify;"><?php echo substr($row['des'], strlen($row['des']) / 2 - 1, -1); ?></p>
                    </div>
                </div>
            </div>
        </div>
